...
| 维度 | 状态 |
|---|---|
| 阶段 | **阶段 2 进行中**(第一批玩法:核心 29 + 跨线路聊天室) |
| 已落地域 | L3 战斗(0/0.5/A.1–A.4)· L2 模型与属性(M.1–M.4b)· 遇敌与战果(M.5–M.7/R.1)· 世界(W.1–W.5)· 道具(I.1–I.4)· 状态(L4.1) |
| 最新批次 | **L4.1 状态异常系统**(§9.0.55,DR-DT24) |
| 锁定 ref | `shared-v0.21.0` 已闭合;⚠️ **L4.1 须前推 `shared-v0.22.0`**(欠债 33) |
| 欠债 | 33 条(✅ 12 闭合 · 🔧 11 部分 · ⬜ 5 未做) |
| 待拍板 | **0 条**(待数据 7,全部不挡关键路径) |
