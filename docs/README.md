...
| **如何启动可玩版本、验证保存重登** | [`deploy/README.md`](../deploy/README.md) · [P2/P3 验收](audits/2026-09-12-playable-loop.md) | 操作说明与当前证据 |
...
| 目录 | 内容 | 规模 |
|---|---|---|
| [`journal/`](journal/) | 逐批次执行记录，按功能模块分 12 个文件 | **57 节**(§9.0.1–9.0.56) |
...
| 最新批次 | [P2/P3 最小可玩流程](audits/2026-09-12-playable-loop.md)已完成：登录创建、真实地图、手动战斗/捕获、保存重登和画面方向修正均已验收 |
| 锁定 ref | **`shared-v0.26.0`**；两远端同步、两端三平台和数据库共 7 项 CI、独立取源与 macOS 原生 GUI 均通过；旧 tag 保留 |
