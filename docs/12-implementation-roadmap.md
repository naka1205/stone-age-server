...
| 09-25 | **阶段 2 最小切片 W.6 + W.7**（§9.0.71/§9.0.72：WARP 传送点踩踏瞬移与视野刷新 · NPC 实体框架与不可穿透碰撞 · Healer 满血满蓝与 `GoldLedger` 扣费 · `world_map` 30→38 例/368→466 断言 · RV-1/RV-2 精准通过） | 推送窗口准备（`shared-v0.33.0`）+ 推进阶段 2 下一步（城镇居民对白与任务 DSL 骨架） |
