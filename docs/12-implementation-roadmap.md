...
| 09-16 | A6（D8 覆盖台账 `13-d8-coverage.md`：核心 29 = ✅3/🔄9/⬜17）+ **批次 A-α 战果总装**（§9.0.67：expForKill 纯函数化 · ISDIE 门 finished 落点钉 · world_tick 139 例/2,504 断言 · 反向验证 2 处精确转红） | ✅ 下一子批 **A-β**（目标选择与守护，含 A5 Guardian） |
