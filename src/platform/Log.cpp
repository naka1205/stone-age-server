...
const char *eventName(LogEvent e) noexcept
{
	switch (e)
	{
	case LogEvent::kUnspecified:
		return "unspecified";
	case LogEvent::kServerStarting:
		return "server_starting";
	case LogEvent::kServerReady:
		return "server_ready";
	case LogEvent::kServerStopping:
		return "server_stopping";
	case LogEvent::kConfigLoaded:
		return "config_loaded";
	case LogEvent::kConfigRejected:
		return "config_rejected";
	case LogEvent::kModuleLoaded:
		return "module_loaded";
	case LogEvent::kListenFailed:
		return "listen_failed";
	case LogEvent::kShutdownSignal:
		return "shutdown_signal";
	case LogEvent::kConnectionAccepted:
		return "connection_accepted";
	case LogEvent::kConnectionClosed:
		return "connection_closed";
	case LogEvent::kHandshakeAccepted:
		return "handshake_accepted";
	case LogEvent::kHandshakeRejected:
		return "handshake_rejected";
	case LogEvent::kFrameRejected:
		return "frame_rejected";
	case LogEvent::kSessionStateChanged:
		return "session_state_changed";
	case LogEvent::kTickBudgetExceeded:
		return "tick_budget_exceeded";
	case LogEvent::kBattleStarted:
		return "battle_started";
	case LogEvent::kBattleTurnResolved:
		return "battle_turn_resolved";
	case LogEvent::kBattleFinished:
		return "battle_finished";
	case LogEvent::kBattleSeed:
		return "battle_seed";
	case LogEvent::kBattleEventsTruncated:
		return "battle_events_truncated";
	case LogEvent::kBattleJoinFailed:
